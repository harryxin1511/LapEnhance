...
import sys
sys.path.append('/home/xin/Experience/Dataload/')
import LoL
from LoL import TheDataset
...
parser.add_argument('--epoch', default=100000, type=int, help='number of total epochs to run')
...
# route = '/home/xin/Experience/dataset/fkc/'
route = '/home/xin/Experience/dataset/LOLdataset/'
