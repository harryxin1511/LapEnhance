...
if __name__ == '__main__':
    ...
    net = MABlock()
    # net = MAConv(in_channels=3, out_channels=3, kernel_size=3, stride=1, padding=1, bias=True,
    #              split=3, reduction=2)
    net = MABlock(in_channels=3, out_channels=3, kernel_size=3, stride=1, padding=1, bias=True,
                 split=3, reduction=2)
